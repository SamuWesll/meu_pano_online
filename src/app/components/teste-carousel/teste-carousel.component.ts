...
@Component({
  selector: 'app-teste-carousel',
  templateUrl: './teste-carousel.component.html',
  styleUrls: ['./teste-carousel.component.css']
})
export class TesteCarouselComponent implements OnInit {
